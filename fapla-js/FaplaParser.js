    ...
    try {
        ...
        case 1:
            ...
            localctx._expression = this.expression(0);
                        ...
                        code += "if ( " + localctx._expression.code + ")";
        ...
        case 2:
            ...
            this.supBlock();
                        ...
                        code += "while ( " + localctx._expression.code + ")";
        ...
        case 3:
            ...
            this.match(FaplaParser.SEMICOLON);
                        ...
                        code += "return " + localctx._expression.code + ";";
        ...
        case 4:
            ...
            localctx._expression = this.expression(0);
             if(!TypeConverting.canConvertTo(localctx._expression.type, "string")) FaplaParser.prototype.logger.error("write exprssion must be a string");
                                        code += "console.log(" + localctx._expression.code + ");";
        ...
        case 5:
            ...
            this.match(FaplaParser.SEMICOLON);
                        ...
                        code += "(localctx._Identifier===null ? null : localctx._Identifier.text) = console.read();";
        ...
        case 6:
            ...
            this.state = 145;
            localctx._expression = this.expression(0);
             code += localctx._expression.code + ";"; 
            this.state = 147;
            this.match(FaplaParser.SEMICOLON);
            break;
